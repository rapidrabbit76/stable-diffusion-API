...
# THIS SCRIPTS FROM: https://github.com/huggingface/diffusers/blob/main/scripts/convert_original_stable_diffusion_to_diffusers.py
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint_path",
        default="./ckpt/anime-diffusion.ckpt",
        type=str,
        required=True,
...
def conver_ckpt_to_diff(
    ...
    original_config_file: str = "./v1-inference.yaml"
